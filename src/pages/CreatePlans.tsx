...
export const CreatePlans: React.FC = () => {
    ...
    const resetPlanForm = () => {
        setFormData({ name: '', description: '', price: 0, features: [''], type: 'SEO', viewsCount: 0 });
        setEditingPlan(null);
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="ADS">Advertisement Campaign</option>
                                    </select>
                                </div>
                                {formData.type === 'VIEWS' && (
                                    <div>
                                        <label className="block text-sm font-medium text-gray-400 mb-2">Views Count</label>
                                        <input
                                            type="number"
                                            required
                                            min="0"
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                {plan.viewsCount && (
                                                    <span className="text-sm text-blue-400">({plan.viewsCount.toLocaleString()} views)</span>
                                                )}
                                            </div>
